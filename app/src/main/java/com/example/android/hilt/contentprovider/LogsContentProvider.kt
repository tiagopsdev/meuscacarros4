...
//import com.example.android.hilt.data.CarDao
...
//            val carDao: CarDao = getLogDao(appContext)
//
//            val cursor: Cursor? = if (code == CODE_LOGS_DIR) {
//                carDao.selectAllLogsCursor()
//            } else {
//                carDao.selectLogById(ContentUris.parseId(uri))
//            }
...
//        throw UnsupportedOperationException("Only reading operations are allowed")
//    }
//    private fun getLogDao(appContext: Context): CarDao {
